...
- **Scroll of Detect Traps** is an identifiable scroll type; using it will identify it for the run.
- New: **Scroll of Detect Secrets** is also identifiable; using it reveals secret doors on the current floor.
