...
inline constexpr ActionInfo kActionInfoTable[] = {
    ...
    {Action::OverworldMapNextLandmark, "overworld_next_landmark", "Overworld atlas: next landmark"},
    {Action::OverworldMapPrevLandmark, "overworld_prev_landmark", "Overworld atlas: previous landmark"},
    {Action::OverworldMapCycleLandmarkFilter, "overworld_landmark_filter", "Overworld atlas: cycle landmark filter"},
    {Action::OverworldMapToggleRoute, "overworld_toggle_route", "Overworld atlas: toggle route preview"},
    {Action::OverworldMapSetWaypoint, "overworld_set_waypoint", "Overworld atlas: set waypoint at cursor"},
    {Action::OverworldMapClearWaypoint, "overworld_clear_waypoint", "Overworld atlas: clear waypoint"},
    {Action::OverworldAutoTravelToWaypoint, "overworld_travel_waypoint", "Overworld: auto-travel to waypoint"},
    {Action::OverworldMapTravelToCursor, "overworld_travel_cursor", "Overworld atlas: auto-travel to cursor"},
    {Action::OverworldAutoTravelNearestWaystation, "overworld_travel_nearest_waystation", "Overworld: auto-travel to nearest waystation"},
    {Action::OverworldAutoTravelNearestStronghold, "overworld_travel_nearest_stronghold", "Overworld: auto-travel to nearest stronghold"},
    {Action::OverworldAutoTravelTogglePause, "overworld_travel_pause", "Overworld: pause/resume auto-travel"},
    ...
    {Action::ToggleViewMode,      "toggle_view_mode", "Cycle view mode (topdown / iso / 3D)"},
    {Action::ViewTurnLeft,        "view_turn_left",   "Turn 3D view left"},
    {Action::ViewTurnRight,       "view_turn_right",  "Turn 3D view right"},
...
inline std::string normalizeToken(std::string_view in) {
    ...
    static constexpr Alias kAliases[] = {
        ...
        {"viewturnleft", "view_turn_left"},
        {"turn_left", "view_turn_left"},
        {"turnleft", "view_turn_left"},
