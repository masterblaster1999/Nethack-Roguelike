...
# Overworld atlas helpers (FIND): cycle discovered waystations/strongholds.
bind_overworld_next_landmark = ctrl+f
bind_overworld_prev_landmark = ctrl+shift+f
bind_overworld_landmark_filter = ctrl+l
bind_overworld_toggle_route = ctrl+r
bind_overworld_set_waypoint = ctrl+w
bind_overworld_clear_waypoint = ctrl+shift+w
bind_overworld_travel_waypoint = ctrl+g
bind_overworld_travel_cursor = ctrl+shift+g
bind_overworld_travel_nearest_waystation = ctrl+y
bind_overworld_travel_nearest_stronghold = ctrl+u
bind_overworld_travel_pause = ctrl+o
